...
def get_diagnosis_groups(diagnosis, optional_exclusions=None):
    ...
    be passed as a list into the optional_exclusions parameter. This parameter can
...
def add_chart_data(df):
    ...
    This function takes a given dataframe of admissions and merges on the first
